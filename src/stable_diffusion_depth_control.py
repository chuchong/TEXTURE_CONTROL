...
class StableDiffusionControl(nn.Module):
    ...
    def __init__(self, device, model_name='CompVis/stable-diffusion-v1-4', concept_name=None, concept_path=None,
        ...
        self.tokenizer = CLIPTokenizer.from_pretrained(model_name, subfolder='tokenizer', use_auth_token=self.token,  proxies=proxies)
        self.text_encoder = CLIPTextModel.from_pretrained(model_name, subfolder='text_encoder',   proxies=proxies,
